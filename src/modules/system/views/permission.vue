    ...
    <div class="input-form" id="create">
      ...
      <el-form ref="form" :model="currentNode" label-width="70px" class="editForm">
        ...
        <el-form-item label="是否可见">
          <el-switch v-model="currentNode.visible" :active-value="1" :inactive-value="0" class="input-item"></el-switch>
        </el-form-item>
        <el-form-item>
    ...
    :close-on-click-modal="false"
      ...
      <el-form :model="submenuForm" :label-width="formLabelWidth">
        ...
        <el-form-item label="排序">
          <el-input-number v-model="submenuForm.sortOrder"></el-input-number>
        </el-form-item>
        <el-form-item label="是否启用">
      ...
      * */
      openAddSubmenuDialog() {
        if (this.currentNode.id === '') {
          ...
          this.submenuForm.visible = this.currentNode.visible;
          this.submenuForm.delFlag = this.currentNode.delFlag?1:-1;
