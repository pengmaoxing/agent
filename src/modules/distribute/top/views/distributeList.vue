    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <!--<el-button type="text" @click="distributeUpdateAudit(scope.row.id,3)" :disabled="scope.row.status===2?false:true">审核</el-button>-->
          <!--<el-button type="text" @click="distributeUpdateAudit(scope.row.id,1)" :disabled="scope.row.status===2?false:true">驳回审核</el-button>-->
