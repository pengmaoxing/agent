  ...
  <div class="app-container" v-loading="loading">
    ...
    <el-table
      ...
      <el-table-column
        label="操作">
        <template slot-scope="scope">
          <el-button type="text" @click="distributeUpdateAudit(scope.row.id,3)" :loading="btnLoading"
                     :disabled="scope.row.status===2?false:true">通过审核
          </el-button>
          <el-button type="text" @click="distributeUpdateAudit(scope.row.id,6)" :loading="btnLoading"
