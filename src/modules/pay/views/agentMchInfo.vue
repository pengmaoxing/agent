...
<script>
  import {getMchInfoListByFuwushang, detail} from '@/modules/merchant/agent/api/merchantInfo'
  ...
  export default {
    ...
    mounted () {
      this.getMchInfoListByFuwushang()
    },
    methods: {
      ...
      getMchInfoListByFuwushang (number, pageSize) {
        this.loading = true
        getMchInfoListByFuwushang(number, pageSize, this.queryList).then(response => {
