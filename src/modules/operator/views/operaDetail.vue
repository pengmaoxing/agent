      ...
      <div>
        <table width="100%" class="info_table">
          ...
          <tr>
            ...
            <!--<td class="tb_title">合作级别</td>   &lt;!&ndash;标题&ndash;&gt;-->
            <!--<td class="tb_text">-->
              <!--<template>-->
                <!--<template v-if="operaDetail.cooperationLev===1">顶级运营商</template>-->
                <!--<template v-else-if="operaDetail.cooperationLev===2">普通运营商</template>-->
              <!--</template>-->
            <!--</td>  &lt;!&ndash;内容&ndash;&gt;-->
    ...
    <el-card class="box-card" style="margin-top: 20px">
      ...
      <div>
        <el-tabs v-model="activeName" @tab-click="changeTabs">
          <!--渠道商-->
          <el-tab-pane :label="disName+'列表'" name="1">
            <!--列表-->
            <el-table
              :data="disTributeData"
              empty-text="未查询到数据"
  ...
  export default {
    ...
    methods: {
      ...
      getDistributeList: function (number, pageSize) {
        // 需要运营商ID
        let id = this.id
        getDistributeList(number, pageSize, id).then(response => {
