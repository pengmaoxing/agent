    ...
    <el-table
      ...
      label="操作">
        <template slot-scope="scope">
          ...
          <el-button type="text" @click="distributeUpdateAudit(scope.row.id,2)" :loading="btnLoading"
          ...
          <!--<el-button type="text" @click="distributeUpdateAudit(scope.row.id,6)" :disabled="scope.row.status===2?false:true">驳回</el-button>-->
        </template>
      </el-table-column>
    </el-table>
