...
export const wxmduploadUrl = url + uploadPrefix + '/upload/path/file_upload';

export const veruploadUrl = url + uploadPrefix + '/upload/common_upload';

export const newUploadUrl = url + uploadPrefix + '/upload/path/file_upload';
export const filsUploadUrl = url + '/device/'; //设备管理用  20191024
