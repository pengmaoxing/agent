<template>
  <div class="app-container" v-loading="loading">
    <div class="action-container">
      ...
      <!--支付通道-->
      <el-select v-model="flowCollectForm.payChannel" @change="flowCollectGetPayChannelLabel" placeholder="支付通道" size="small" clearable class="formItem">
        <el-option
  ...
  export default {
    ...
    methods: {
      getList(number, pageSize) {
        ...
        collectById(number, pageSize, submitForm).then(response => {
