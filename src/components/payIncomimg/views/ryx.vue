    ...
    <el-form :model="form" ref="form" :rules="rules" :label-width="labelWidth" :size="inputSize">
      <el-card class="box-card">
        ...
        <div>
          ...
          <el-form-item label="渠道：" prop="pay_type">
            ...
            <el-option value="ruiyinxin" label="ruiyinxin"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="云闪付费率：">千分之
            <el-input-number v-model="form.rate_unionpay"
                             controls-position="right" :precision="1" :step="1" :min="0" :max="1000"
                             label="云闪付费率">
      ...
      <el-card class="box-card" style="margin-top: 14px">
        ...
        <div class="btn-group" v-if="mode==='verify'">
          ...
          <el-button type="primary" @click="dataCollation" :loading="btnLoading">瑞银信审核通过</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      dataInputPMI: function (row) {
        ...
        this.form.rate_unionpay = data.rate_unionpay || 0.0; //额外手续费
        ...
        this.form.pay_type = data.pay_type || 'ruiyinxin'; //渠道 lb
