    ...
    <el-form :model="form" ref="form" :rules="rules" :label-width="labelWidth" :size="inputSize">
        ...
        <div>
          ...
          <el-form-item label="渠道：" prop="pay_type">
            <el-select v-model="form.pay_type" placeholder="渠道">
              <el-option value="yirongma" label="和融通"></el-option>
              <el-option value="cloudpay" label="微信买单"></el-option>
              <el-option value="suixingfu" label="随行付"></el-option>
              <el-option value="fufeitong" label="付费通"></el-option>
            </el-select>
          </el-form-item>
      ...
      <el-card class="box-card" style="margin-top: 14px">
        ...
        <div class="btn-group" v-if="mode==='verify'">
          <el-button type="" @click="goQuit">退出</el-button>
          <el-button @click="submitReject">驳回</el-button>
          <el-button type="primary" @click="dataCollation" :loading="btnLoading">惠闪付审核通过</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      dataInputPMI: function (row) {
        ...
        this.form.pay_type = data.pay_type || 'fufeitong'; //渠道 lb
