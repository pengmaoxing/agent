...
export function hsfUpdate(form) {
  return request({
    url: '/merchant/hk_mch_info/hsf_mch_info/save',
    method: 'post',
    data: qs.stringify(
      form
    )
...
export function hsfFileUpdate(form) {
  return request({
    url: 'merchant/hk_mch_info/internal/registernewmerchant',
    method: 'post',
    data: qs.stringify(
      form
    )
...
export function hsfImgUpdate(form) {
  return request({
    url: '/merchant/hk_mch_info/photo/internal/registernewmerchant',
    method: 'post',
    data: qs.stringify(
      form
    )
...
export function hsfRegister(id) {
  return request({
    url: '/merchant/hk_mch_info/internal/registernewmerchant/release',
    method: 'post',
    data: qs.stringify({
      merchantId: id
    })
...
export function hsfImageRegister(id) {
  return request({
    url: '/merchant/hk_mch_info/photo/internal/registernewmerchant/release',
    method: 'post',
    timeout: 60000,
    data: qs.stringify({
      merchantId: id
